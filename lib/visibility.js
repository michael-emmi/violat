...
class Visibility {
  ...
  weaken(inv1, inv2, weak, relax) {
    ...
    let that = new Visibility({
      ...
      consistency: this.consistency,
      weakened: this.weakened.concat([[inv1, inv2]]),
  ...
  finalize() {
    ...
    for (let [i1,i2] of that.weakened) {
      this.consistency = that.consistency
