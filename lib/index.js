...
async function schemaFile(args) {
  ...
  let ary = Array.from(enumeration.generator(spec, args.method, args.vaues, args.sequences, args.invocations)());
...
async function testMethod(args) {
  try {
    ...
    for (let idx in chunks) {
      ...
      let harnesses = await translation.translate(annotated, args.method.capitalize());
