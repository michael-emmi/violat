...
module.exports = function(schemas, weak) {
  return new Promise(async (resolve, reject) => {
    ...
    let arguments = ['-ea', '-jar', jcsgen];
    if (weak) {
      arguments.push('--weak');
      arguments.push('--weak-relax-lin-happens-before');
      arguments.push('--weak-relax-vis-happens-before');
      arguments.push('--weak-relax-returns');
    }
    let proc = cp.spawn('java', arguments);
